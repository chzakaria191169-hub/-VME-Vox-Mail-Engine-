// src/providers/zoho/ZohoProvider.ts
...
export class ZohoProvider extends BaseProvider {
  readonly providerType = ProviderType.ZOHO;
  ...
  async testConnection(): Promise<ConnectionTestResult> {
    ...
    try {
      ...
      result.smtpError = err.message || 'SMTP Verification Failed';
    }
    ...
    try {
      ...
      result.imapError = err.message || 'IMAP Connection Failed';
    }
